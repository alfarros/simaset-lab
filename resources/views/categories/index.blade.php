        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-4">
                ...
                @forelse($allCategories as $category)
                    <a href="{{ route('categories.show', $category->value) }}" 
                       class="block bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg 
                              transform transition-all duration-300 hover:scale-105 hover:shadow-lg mb-4">
                        
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            
                            <div class="mb-4">
                                @if ($category == App\Enums\AssetCategory::HARDWARE)
                                ...
                                @elseif ($category == App\Enums\AssetCategory::PENDUKUNG)
                                 ...
                                 @elseif ($category == App\Enums\AssetCategory::JARINGAN)
                                 ...
                                 @elseif ($category == App\Enums\AssetCategory::FURNITUR)
                            ...
                            <h3 class="text-xl font-semibold">{{ $category->value }}</h3>
                            <p class="text-gray-500 dark:text-gray-400">
                                {{ $categoriesWithCount[$category->value] ?? 0 }} Aset
                            </p>
